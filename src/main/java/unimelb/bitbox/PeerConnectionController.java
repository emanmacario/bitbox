...
public class PeerConnectionController implements FileSystemObserver, Runnable {
    ...
    private Queue<FileSystemEvent> events; // TODO: Determine if shared queue is best?
     ...
     */
    public void start() {
        Thread peerConnectionControllerThread = new Thread(this);
        peerConnectionControllerThread.start();
        log.info("PeerConnectionController Thread started...");
    }


    /**
     * Relays file system events generated by
     * the FSM method generateSyncEvents() to all PeerClient threads,
     * after every 'syncInterval' seconds interval of time.
     */
    @Override
    public void run() {
        while (true) {
